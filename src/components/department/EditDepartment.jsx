...
const EditDepartment = () => {
    ...
    return (
        <>{depLoading ? <div className="flex items-center justify-center min-h-screen">
      <div role="status">
        <svg
          aria-hidden="true"
            ...
            <div className='max-w-3xl mx-auto mt-10 bg-white p-8 rounded-md shadow-md w-96'>
                ...
                <form onSubmit={handleSubmit} >
                    ...
                    <div className='mt-3'>
                        ...
                        <textarea name="description" onChange={handleChange} value={department.description} placeholder='Description' className='mt-1 w-full p-2 border border-gray-300 rounded-md' rows="4"></textarea>
                    </div>
