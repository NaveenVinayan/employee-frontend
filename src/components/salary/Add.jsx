...
const Add = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`https://employee-api-eight.vercel.app/api/salary/add`, salary, {
                headers: {
                ...
                <form onSubmit={handleSubmit}>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input type="number" name='basicSalary' onChange={handleChange} placeholder='Insert salary' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name='allowances' onChange={handleChange} placeholder='Monthly Allowances' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
                        </div>

                        {/* Deductions */}
                        <div>
                            <label className='block text-sm font-medium text-gray-700'>Deductions</label>
                            <input type="number" name='deductions' onChange={handleChange} placeholder='Monthly Deductions' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required />
                        </div>
                        ...
                        <button type='submit' className='w-full mt-6 bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 col-span-1 md:col-span-2'>Add Salary</button>
